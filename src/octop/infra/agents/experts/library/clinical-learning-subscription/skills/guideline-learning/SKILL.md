...
最终依据只用 source-policy.yaml 允许的权威信源；学习内容必须含至少一个权威原文链接 `来源：名称：[链接](URL)`；找不到时标待人工复核，不得编造。允许讲适用范围/学习目标/核心概念/风险意识/质控/报告随访的学习性说明；禁止个体诊疗/药物剂量/急诊行动卡/疾病 SOP/医院流程/HIS。
